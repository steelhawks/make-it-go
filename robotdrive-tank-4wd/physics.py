...
class PhysicsEngine(object):
    ...
    def update_sim(self, now, tm_diff):
        ...
        lf_motor = wpilib.DigitalModule._pwm[0].Get()
        lr_motor = wpilib.DigitalModule._pwm[1].Get()
        rf_motor = wpilib.DigitalModule._pwm[2].Get()
        rr_motor = wpilib.DigitalModule._pwm[3].Get()
